...
| B5 | UFW aktiv, öffentliches SSH blockiert | `ufw status verbose`: Status active, keine generische `22/tcp ALLOW IN Anywhere`-Regel (cloud-config-Regel gelöscht), `DENY IN on <public_iface>` vorhanden |

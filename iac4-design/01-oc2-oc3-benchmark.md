...
3. **PROD-OC3** bleibt bis Benchmark-Abschluss `enabled: false` — **ENTSCHEIDEN (2026-08-12): PROD-OC3 aktiviert** (Best-Practice-Referenz, group_vars/vps-prod.yml enabled: true)

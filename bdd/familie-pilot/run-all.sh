#!/usr/bin/env bash
# run-all.sh – Fuehrt alle Pilot-BDD-Checks K1..K9 aus (bdd/familie-pilot/)
...
for k in k1_health k2_bots_persona k3_storage_separation k4_shared_llm_keys \
         k5_secrets_not_in_git k6_update_backup_restart k7_review k8_no_merge k9_workflow05; do
  echo ""
  echo "########## $k ##########"
